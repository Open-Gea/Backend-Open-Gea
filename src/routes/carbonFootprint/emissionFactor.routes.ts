...
import { EmissionFactorService } from '../../services/carbonFootprint/emissionFactor.service';
import { BaseError, isAnError, YvYError } from '../../utils/error';

export default function emissionFactorRouter(
  service: EmissionFactorService
): Router {
  return Router()
