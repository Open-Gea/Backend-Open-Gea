...
import { PruningManagementService } from '../../services/soilReg/pruningManagement.service';
import { isAnError } from '../../utils/error';

export default function PruningManagementRouter(service: PruningManagementService): Router {
  return Router()
