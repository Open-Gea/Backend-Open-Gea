...
import { FertilizationService } from '../../services/soilReg/fertilization.service';
import { isAnError } from '../../utils/error';


export default function fertilizationRouter(service: FertilizationService): Router {
  return Router()
