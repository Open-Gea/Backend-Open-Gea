...
import { IrrigationSystemsService } from '../../services/soilReg/irrigationSystems.service';
import { isAnError } from '../../utils/error';

export default function irrigationSystemsRouter(service: IrrigationSystemsService): Router {
  return Router()
